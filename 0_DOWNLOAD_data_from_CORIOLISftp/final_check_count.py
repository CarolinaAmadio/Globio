...
df=pd.read_csv('/g100_work/OGS_devC/camadio/GLOBIO/files_downloaded_but_not_in_float_index.csv')

directory = '/g100_work/OGS_devC/camadio/GLOBIO/CORIOLIS/download/duplicates'
...
for FILE in df.Filename:
    tmp = 'SD' + FILE[2:]
    tmp = '/g100_work/OGS_devC/camadio/GLOBIO/CORIOLIS/download/tmp/'+tmp
    if os.path.exists(tmp):
       print(f"{tmp} exists.")
       shutil.move('/g100_work/OGS_devC/camadio/GLOBIO/CORIOLIS/download/tmp/'+ FILE, directory)
       III+=1
    else:
       import sys
